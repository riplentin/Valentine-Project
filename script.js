...
function selectOption(option) {
    ...
    if (option === 'yes') {
        ...
        document.getElementById('no-button').innerText = 'Malita';
        document.getElementById('yes-button').innerText = 'Sii'; 
...
texto.style.fontSize = "4.8vw";  // Ajuste de tamaño responsivo (porcentaje del ancho de la pantalla)
texto.style.textAlign = "center";
texto.style.fontFamily = "Cookie, sans-serif";

// Establecer el estilo del cuerpo
